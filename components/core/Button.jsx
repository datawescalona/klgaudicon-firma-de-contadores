...
const VARIANTS = {
  ...
  cta: {
    ...
    border: '1px solid transparent', boxShadow: '0 6px 18px rgba(168,132,74,0.38)',
  },
  secondary: {
...
export function Button({
  ...
  const base = {
    ...
    lineHeight: 1, letterSpacing: '0.01em', borderRadius: '8px',
    ...
    ...(hover && !disabled && variant === 'cta' ? { background: 'var(--cta-hover)', borderColor: 'transparent', boxShadow: '0 10px 26px rgba(168,132,74,0.48)' } : {}),
