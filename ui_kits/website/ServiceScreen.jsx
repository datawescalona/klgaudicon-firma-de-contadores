    ...
    <div>
      <section style={{ background: 'var(--bg-sunken)', borderBottom: '1px solid var(--border-subtle)' }}>
        <div style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: 'var(--space-12) var(--gutter) var(--space-10)' }}>
          <button onClick={() => go('servicios')} style={{ background: 'none', border: 0, color: 'var(--text-muted)', fontFamily: 'var(--font-sans)', fontSize: 14, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 6, padding: 0, marginBottom: 22 }}>
            <Icon n="arrow-left" s={16} /> Servicios
          </button>
