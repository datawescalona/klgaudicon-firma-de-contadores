...
function Hero({ go }) {
  ...
  return (
    <section className="klg-section klg-section--flush" data-nav-theme="dark" style={{ position: 'relative', overflow: 'hidden', background: 'var(--navy-950)', marginTop: -88, minHeight: 'calc(100vh + 88px)', justifyContent: 'flex-start' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, flexGrow: 1, display: 'flex', alignItems: 'center', paddingTop: 124, paddingBottom: 36 }}>
        <div className="klg-pad" style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: '0 var(--gutter)', width: '100%' }}>
          <div style={{ maxWidth: 800 }}>
            <h1 style={{ margin: '0 0 16px', fontFamily: 'var(--font-mono)', fontWeight: 500, fontSize: 12, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--gold-300)' }}>Firma de Auditores Financieros · Caracas, Venezuela</h1>
            <h2 style={{ fontSize: 'clamp(2.1rem, 4.2vw, 3.7rem)', lineHeight: 1.05, color: '#fff', margin: 0, letterSpacing: '-0.025em' }}>
